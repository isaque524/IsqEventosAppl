...
export class RedesSociaisComponent implements OnInit {
  ...
  public retornaIcone(nome: string): SafeHtml {
    if (!nome) {
      return this.sanitizer.bypassSecurityTrustHtml('<span>Rede Social</span>');
    }
    return this.sanitizer.bypassSecurityTrustHtml(`<i class="${nome}"></i>`);
  }
